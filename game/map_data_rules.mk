...
$(MAP_LAYOUT_OUTPUTS) &: $(LAYOUTS_DIR)/layouts.json $(MAP_VERSION_STAMP) $(MAPJSON) $(WAYFARER_SEVII_MANIFEST) $(WAYFARER_SINNOH_MANIFEST_DEP) $(WAYFARER_SINNOH_ASSET_MANIFEST_DEP)
