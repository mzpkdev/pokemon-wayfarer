...
TEST("Wayfarer Trainer IDs keep HNS stable and map Hoenn after it")
{
    ...
    EXPECT_EQ(TRAINER_WAYFARER_KANTO_FIRST, 1795);
    EXPECT_EQ(TRAINER_WAYFARER_KANTO_BLUE_BULBASAUR, 1795);
    EXPECT_EQ(TRAINER_WAYFARER_KANTO_BLUE_CHARMANDER, 1796);
    EXPECT_EQ(TRAINER_WAYFARER_KANTO_BLUE_SQUIRTLE, 1797);
    EXPECT_EQ(TRAINER_WAYFARER_KANTO_LAST, 1797);
    EXPECT_EQ(TRAINERS_COUNT_WAYFARER, 1798);
