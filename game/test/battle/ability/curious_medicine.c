...
{
    // TODO(nightly-failures): Curious Medicine's switch-in stat-reset sequence emits additional or reordered messages. Re-enable after its event ordering is aligned.
    KNOWN_FAILING;
