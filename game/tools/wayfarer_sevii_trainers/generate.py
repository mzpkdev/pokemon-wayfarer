...
def render_coordination(report: dict) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "Story owns the `SaveBlock3` aggregate and new-game/save-version plumbing. The shared runtime contract is a compact 136-bit payload indexed by allocation slot, exposed without revealing the aggregate:",
            "",
            "```c",
