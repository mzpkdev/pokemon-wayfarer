...
class ProgressionTests(unittest.TestCase):
    ...
    def test_interning_does_not_couple_names(self):
        ...
        self.assertNotIn("struct ProgressionCurve", original)
        self.assertIn("switch (curveId)", original)
        self.assertIn("case GAMEPLAY_CURVE_ORDINARY_TRAINER_BASELINE:", original)
        self.assertIn("case GAMEPLAY_CURVE_SOFT_CAP:\n    case GAMEPLAY_CURVE_GYM_BASELINE:\n    case GAMEPLAY_CURVE_LEAGUE_BASELINE:", original)
