...
// Vs. Seeker
// Wayfarer owns the ordinary Sevii rematch flow. Other products deliberately
// retain the disabled configuration and their existing rematch behavior.
#if defined(POKEMON_WAYFARER)
#define I_VS_SEEKER_CHARGING        FLAG_WAYFARER_SEVII_VS_SEEKER_CHARGING
#else
#define I_VS_SEEKER_CHARGING        0
#endif
