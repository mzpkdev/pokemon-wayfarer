...
enum TrainerOnlyAction { TRAINER_ONLY_ROCK, TRAINER_ONLY_BALL, TRAINER_ONLY_NEAR, TRAINER_ONLY_RUN, TRAINER_ONLY_FOOD, TRAINER_ONLY_RECOVERY, TRAINER_ONLY_QUICK_BALL };
#define TRAINER_ONLY_ITEM_BALL TRAINER_ONLY_BALL
#define TRAINER_ONLY_ITEM_FOOD TRAINER_ONLY_FOOD
#define TRAINER_ONLY_ITEM_RECOVERY TRAINER_ONLY_RECOVERY
