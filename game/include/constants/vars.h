...
#define VAR_WAYFARER_SEVII_HERACROSS_SIZE_RECORD          WAYFARER_SEVII_VAR_ID(4)
#define VAR_WAYFARER_SEAFOAM_B4F_CURRENT_ENTRY            WAYFARER_COAST_VAR_ID(0)
#define VAR_WAYFARER_CINNABAR_LAB_FOSSIL_STATE            WAYFARER_COAST_VAR_ID(1)
#define VAR_WAYFARER_CINNABAR_LAB_FOSSIL_KIND             WAYFARER_COAST_VAR_ID(2)
#define VAR_WAYFARER_COAST_REMATCH_STAGES_LOW             WAYFARER_COAST_VAR_ID(3)
#define VAR_WAYFARER_COAST_REMATCH_STAGES_HIGH            WAYFARER_COAST_VAR_ID(4)
#define VAR_WAYFARER_PALLET_TOWN_STATE                    WAYFARER_COAST_VAR_ID(5)
#else
...
#define VAR_TRAINER_RATING                                0x40F7 // Persistent wild encounter scaling progression
