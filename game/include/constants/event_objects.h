...
#if IS_WAYFARER
// Sevii's FRLG NPC colors occupy the same fixed slots as the generic palettes.
#define OBJ_EVENT_PAL_TAG_NPC_BLUE                OBJ_EVENT_PAL_TAG_NPC_1
#define OBJ_EVENT_PAL_TAG_NPC_PINK                OBJ_EVENT_PAL_TAG_NPC_2
#define OBJ_EVENT_PAL_TAG_NPC_GREEN               OBJ_EVENT_PAL_TAG_NPC_3
#define OBJ_EVENT_PAL_TAG_NPC_WHITE               OBJ_EVENT_PAL_TAG_NPC_4
#define OBJ_EVENT_PAL_TAG_NPC_BLUE_REFLECTION     OBJ_EVENT_PAL_TAG_NPC_1_REFLECTION
#define OBJ_EVENT_PAL_TAG_NPC_PINK_REFLECTION     OBJ_EVENT_PAL_TAG_NPC_2_REFLECTION
#define OBJ_EVENT_PAL_TAG_NPC_GREEN_REFLECTION    OBJ_EVENT_PAL_TAG_NPC_3_REFLECTION
#define OBJ_EVENT_PAL_TAG_NPC_WHITE_REFLECTION    OBJ_EVENT_PAL_TAG_NPC_4_REFLECTION
#else
