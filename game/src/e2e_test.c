...
STATIC_ASSERT(sizeof(struct E2ETestState) == 460, E2ETestStateSize);
STATIC_ASSERT(offsetof(struct E2ETestState, trainerOnlyState) == 382, E2ETestTrainerOnlyStateOffset);
STATIC_ASSERT(offsetof(struct E2ETestState, money) == 396, E2ETestMoneyOffset);
STATIC_ASSERT(offsetof(struct E2ETestState, partyHp) == 400, E2ETestPartyHpOffset);
STATIC_ASSERT(offsetof(struct E2ETestState, partyStatus) == 412, E2ETestPartyStatusOffset);
STATIC_ASSERT(offsetof(struct E2ETestState, partyPp) == 436, E2ETestPartyPpOffset);
...
static enum E2ETestError ValidateArrangeRequest(void)
{
    ...
    if (sRequest.applyLeagueCircuit > TRUE || sRequest.reserved != 0)
