...
#if IS_WAYFARER
    sDecor_CameraSpriteObjectIdx2 = CreateObjectGraphicsSprite(GetPlayerAvatarGraphicsIdByStateId(PLAYER_AVATAR_STATE_NORMAL), SpriteCallbackDummy, x, 72, 0);
    StartSpriteAnim(&gSprites[sDecor_CameraSpriteObjectIdx2], ANIM_STD_FACE_WEST);
#elif IS_HNS
...
#if IS_WAYFARER
    sDecor_CameraSpriteObjectIdx2 = CreateObjectGraphicsSprite(GetPlayerAvatarGraphicsIdByStateId(PLAYER_AVATAR_STATE_NORMAL), SpriteCallbackDummy, 136, 72, 0);
    StartSpriteAnim(&gSprites[sDecor_CameraSpriteObjectIdx2], ANIM_STD_FACE_WEST);
#elif IS_HNS
    if (gSaveBlock2Ptr->playerGender == MALE)
