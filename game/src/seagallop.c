...
#if IS_WAYFARER
    [SEAGALLOP_VERMILION_CITY]  = {MAP_GROUP(MAP_VERMILION_CITY_PORT_INSIDE_HNS), MAP_NUM(MAP_VERMILION_CITY_PORT_INSIDE_HNS), 0x08, 0x09},
#else
...
#if IS_WAYFARER
    [SEAGALLOP_NAVEL_ROCK]      = {MAP_GROUP(MAP_NAVEL_ROCK_HARBOR), MAP_NUM(MAP_NAVEL_ROCK_HARBOR),             0x08, 0x05},
    [SEAGALLOP_BIRTH_ISLAND]    = {MAP_GROUP(MAP_BIRTH_ISLAND_HARBOR_HNS), MAP_NUM(MAP_BIRTH_ISLAND_HARBOR_HNS), 0x08, 0x05}
#else
