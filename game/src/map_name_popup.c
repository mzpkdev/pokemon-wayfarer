...
#else
// Wayfarer retains Emerald's raw section IDs for Hoenn map headers. Its active
// MAPSEC enum is HNS-based, so use the separate named Hoenn IDs here.
#if IS_WAYFARER
#define HOENN_POPUP_SECTION(section) WAYFARER_HOENN_MAPSEC_##section
#define HOENN_POPUP_LATE_SECTION(section) WAYFARER_HOENN_MAPSEC_##section
#define HOENN_POPUP_TABLE_SIZE WAYFARER_HOENN_MAPSEC_NONE
#else
#define HOENN_POPUP_SECTION(section) MAPSEC_##section
#define HOENN_POPUP_LATE_SECTION(section) (MAPSEC_##section - KANTO_MAPSEC_COUNT)
#define HOENN_POPUP_TABLE_SIZE (MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1)
#endif

static const u8 sHoennMapSectionToThemeId[HOENN_POPUP_TABLE_SIZE] =
{
    [HOENN_POPUP_SECTION(LITTLEROOT_TOWN)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(OLDALE_TOWN)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(DEWFORD_TOWN)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(LAVARIDGE_TOWN)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(FALLARBOR_TOWN)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(VERDANTURF_TOWN)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(PACIFIDLOG_TOWN)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(PETALBURG_CITY)] = MAPPOPUP_THEME_BRICK,
    [HOENN_POPUP_SECTION(SLATEPORT_CITY)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_SECTION(MAUVILLE_CITY)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_SECTION(RUSTBORO_CITY)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_SECTION(FORTREE_CITY)] = MAPPOPUP_THEME_BRICK,
    [HOENN_POPUP_SECTION(LILYCOVE_CITY)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_SECTION(MOSSDEEP_CITY)] = MAPPOPUP_THEME_BRICK,
    [HOENN_POPUP_SECTION(SOOTOPOLIS_CITY)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_SECTION(EVER_GRANDE_CITY)] = MAPPOPUP_THEME_BRICK,
    [HOENN_POPUP_SECTION(ROUTE_101)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_102)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_103)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_104)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_105)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_106)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_107)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_108)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_109)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_110)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_111)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_112)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_113)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_114)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_115)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_116)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_117)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_118)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_119)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_120)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_121)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_122)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_123)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(ROUTE_124)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_125)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_126)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_127)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_128)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_129)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_130)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_131)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_132)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_133)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(ROUTE_134)] = MAPPOPUP_THEME_UNDERWATER,
    [HOENN_POPUP_SECTION(UNDERWATER_124)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_SECTION(UNDERWATER_126)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_SECTION(UNDERWATER_127)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_SECTION(UNDERWATER_128)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_SECTION(UNDERWATER_SOOTOPOLIS)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_SECTION(GRANITE_CAVE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(MT_CHIMNEY)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(SAFARI_ZONE)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(BATTLE_FRONTIER)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_SECTION(PETALBURG_WOODS)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(RUSTURF_TUNNEL)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(ABANDONED_SHIP)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(NEW_MAUVILLE)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_SECTION(METEOR_FALLS)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(METEOR_FALLS2)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(MT_PYRE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(AQUA_HIDEOUT_OLD)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(SHOAL_CAVE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(SEAFLOOR_CAVERN)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(UNDERWATER_SEAFLOOR_CAVERN)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_SECTION(VICTORY_ROAD)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(MIRAGE_ISLAND)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(CAVE_OF_ORIGIN)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(SOUTHERN_ISLAND)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(FIERY_PATH)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(FIERY_PATH2)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(JAGGED_PASS)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(JAGGED_PASS2)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(SEALED_CHAMBER)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(UNDERWATER_SEALED_CHAMBER)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_SECTION(SCORCHED_SLAB)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(ISLAND_CAVE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(DESERT_RUINS)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(ANCIENT_TOMB)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(INSIDE_OF_TRUCK)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_SECTION(SKY_PILLAR)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(SECRET_BASE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_SECTION(DYNAMIC)] = MAPPOPUP_THEME_MARBLE,
    [HOENN_POPUP_LATE_SECTION(AQUA_HIDEOUT)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(MAGMA_HIDEOUT)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(MIRAGE_TOWER)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(BIRTH_ISLAND)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_LATE_SECTION(FARAWAY_ISLAND)] = MAPPOPUP_THEME_WOOD,
    [HOENN_POPUP_LATE_SECTION(ARTISAN_CAVE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(MARINE_CAVE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(UNDERWATER_MARINE_CAVE)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_LATE_SECTION(TERRA_CAVE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(UNDERWATER_105)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_LATE_SECTION(UNDERWATER_125)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_LATE_SECTION(UNDERWATER_129)] = MAPPOPUP_THEME_STONE2,
    [HOENN_POPUP_LATE_SECTION(DESERT_UNDERPASS)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(ALTERING_CAVE)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(NAVEL_ROCK)] = MAPPOPUP_THEME_STONE,
    [HOENN_POPUP_LATE_SECTION(TRAINER_HILL)] = MAPPOPUP_THEME_MARBLE,
};
#undef HOENN_POPUP_SECTION
#undef HOENN_POPUP_LATE_SECTION
#undef HOENN_POPUP_TABLE_SIZE
#endif // IS_HNS && !IS_WAYFARER

#if IS_WAYFARER
static u8 GetWayfarerMapPopUpTheme(mapsec_u16_t mapSectionId)
{
    // Map types cover most locations; these sections need a more specific
    // Emerald frame, including sea routes marked as ordinary routes.
    // Pokémon Mansion's section ID aliases zero in the HNS catalog, so use
    // its layouts rather than styling every map with that placeholder ID.
    switch (gMapHeader.mapLayoutId)
    {
    case LAYOUT_POKEMON_MANSION_1F:
    case LAYOUT_POKEMON_MANSION_2F:
    case LAYOUT_POKEMON_MANSION_3F:
    case LAYOUT_POKEMON_MANSION_B1F:
        return MAPPOPUP_THEME_STONE;
    }
    ...
    case MAPSEC_SINNOH_ROUTE_220:
    case MAPSEC_SINNOH_ROUTE_223:
    case MAPSEC_SINNOH_ROUTE_230:
        return MAPPOPUP_THEME_UNDERWATER;
    case MAPSEC_S_S_ANNE:
    case MAPSEC_CINNABAR_ISLAND:
    case MAPSEC_FARAWAY_ISLAND:
        return MAPPOPUP_THEME_WOOD;
    ...
    case MAPSEC_SINNOH_OREBURGH_CITY:
    case MAPSEC_SINNOH_ETERNA_CITY:
    case MAPSEC_ROCKET_WAREHOUSE:
        return MAPPOPUP_THEME_BRICK;
    case MAPSEC_SINNOH_VEILSTONE_CITY:
    case MAPSEC_SINNOH_POKEMON_LEAGUE:
        return MAPPOPUP_THEME_MARBLE;
    }
...
static void LoadMapNamePopUpWindowBg(void)
{
    ...
    else
    {
        ...
        if (WayfarerIsCurrentMapHoennSource())
            popUpThemeId = regionMapSectionId < ARRAY_COUNT(sHoennMapSectionToThemeId)
                               ? sHoennMapSectionToThemeId[regionMapSectionId]
                               : MAPPOPUP_THEME_WOOD;
        else
            popUpThemeId = GetWayfarerMapPopUpTheme(regionMapSectionId);
#elif IS_HNS
        popUpThemeId = sMapSectionToThemeId[regionMapSectionId];
#else
        popUpThemeId = sHoennMapSectionToThemeId[regionMapSectionId];
#endif
