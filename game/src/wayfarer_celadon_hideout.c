...
{
    if (trainerId < TRAINER_CELADON_HIDEOUT_FIRST || trainerId > TRAINER_CELADON_HIDEOUT_LAST)
        return 0;
    return FLAG_WAYFARER_CELADON_HIDEOUT_TRAINER_GRUNT_7
         + trainerId - TRAINER_CELADON_HIDEOUT_FIRST;
}
