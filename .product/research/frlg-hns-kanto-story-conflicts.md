...
Lavender's shared radio and memorial building is now selected in the
[Kanto story PRD](../prds/frlg-kanto-story-on-hns-maps.md#lavender-during-the-radio-conversion)
and detailed in the [Tower specification](../specs/frlg-kanto-pokemon-tower.md).
The operating Power Plant plus old generating hall is selected in that PRD and
the [Power Plant specification](../specs/frlg-kanto-power-plant.md).
...
| Lavender radio station, Soul House, and Fuji | Station occupies Tower's role; Fuji is already safe; radio guard assumes Johto's takeover has happened. | Selected after this inventory: the existing radio lobby is the renovated ground floor, FRLG memorial floors remain above, and Soul House is an active chapel receiving memorials. Hide Fuji from Soul House during the incident, return him to his HNS House1 home after rescue for the physical Flute, and remove the guard's fixed chronology claim. Tower access and radio repair are independent. The Tower specification owns the guard fade to 2F and downstairs return to the lobby, without `map.bin` edits. |
