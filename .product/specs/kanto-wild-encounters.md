...
That revision's core implementation is complete, while full route acceptance
remains pending. Unrelated ecology, authored encounter rules, scaling and
standalone-build contracts remain unchanged.
