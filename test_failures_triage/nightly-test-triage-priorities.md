...
8. **Keep the exact presentation expectation batches.** Canonical names were capitalized in HnS commit `73c788a6b1`, while many imported battle expectations still used title case. Evidence-backed batches align expectations with the rendered species, form, move, ability, item, generic stat labels, glyphs, and automatic wrapping only where decoded expected and observed content otherwise matches exactly. Waves 25 through 27 added 302 exact substitutions across 127 test files, moving the full suite from 3,484 to 3,671 passes. The final Wave 27 scan found no remaining candidate under the strict deterministic first-message gate. Exact matching remains in place. Do not make matching case-insensitive or revert production names because those options would weaken assertions or change visible gameplay.
...
1. Remaining message classification. The strict presentation-only lane is exhausted as of Wave 27. The remaining message failures involve substantive content, actors, ordering, probability wrappers, overwritten histories, or no retained unmatched message for the pending expectation. Keep exact matching and do not infer a capitalization or wrapping cause without a directly decoded expected and observed pair.
